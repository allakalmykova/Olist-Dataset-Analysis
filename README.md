...
В моей [следующей работе](https://github.com/allakalmykova/SalesAnalytics.git) в Power BI я начала сокращать кол-во таблиц, с которым работаю, и использовать больше мер - работая с большими количествами данных очень важно использовать как можно меньше таблиц и столбцов.
